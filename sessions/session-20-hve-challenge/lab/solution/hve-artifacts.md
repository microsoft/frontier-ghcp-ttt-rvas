...
**Expected paths:** `.copilot-tracking/plans/`, `.copilot-tracking/details/`, and
...
The planning log should record any difference between research, Product Manager
Advisor, Agile Coach, and the final plan.
...
Standalone mode exposes and gates each handoff. Combined `/rpi` orchestrates the
same phases and adds Discover after Review. Discover proposes follow-up work; it
does not silently expand the approved implementation.